<template>
  <div class="min-h-screen bg-cream flex flex-col">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-sand flex items-stretch">
      ...
      <!-- pesanan -->
      <NuxtLink to="/orders" class="flex-1 flex flex-col items-center justify-center gap-0.5 py-2.5 text-gray-400 hover:text-primary-600 transition-colors" active-class="text-primary-600">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v8m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h1a2 2 0 012 2v12a2 2 0 01-2 2h-1a2 2 0 01-2-2z" />
        </svg>
